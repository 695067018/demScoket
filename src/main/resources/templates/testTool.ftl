...
<body>
<div id="tabs-1" style="width: 1600px;display: block">
    <div style="float: left; width: 400px;">
        <h2>测试(test)</h2>
        <div>
            <strong>[webSocket]</strong><br/>
            msg:<input class="textbox" type="text" id="test-SockJS" style="width: 100px;"
                       value="SockJS"/>
            <input type="button" value="发送" onclick="connect"/><br>
        </div>
    </div>
</div>
